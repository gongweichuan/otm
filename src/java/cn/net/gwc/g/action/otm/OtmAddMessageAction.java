...
/**
 * <p>文件名称：OtmAddMessageAction.java</p>
 * <p>文件描述：</p>
 ...
 */
public class OtmAddMessageAction extends AbstractAction
{   
    Logger log=Logger.getLogger(OtmAddMessageAction.class);
    ...
    public Map perform(BaseDTO request)
    {
       ...
       String messageId=null;
        ...
        if(service!=null)
        {
            messageId=service.createMessages(inDTO);
        }
        else
        {
        ...
        map.put(Constants.SUCCESS_RETURN_DTO_KEY, messageId);    
        return map;        
    }
