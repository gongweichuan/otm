...
/**
 * <p>文件名称：OtmAddVisitAction.java</p>
 * <p>文件描述：</p>
 ...
 */
public class OtmAddVisitAction extends AbstractAction
{

    Logger log=Logger.getLogger(OtmAddVisitAction.class);
    ...
    public Map perform(BaseDTO request)
    {
       ...
       String visitId=null;
        ...
        if(service!=null)
        {
            visitId=service.createVisits(inDTO);
        }
        else
        {
        ...
        map.put(Constants.SUCCESS_RETURN_DTO_KEY, visitId);    
        return map;        
    }
