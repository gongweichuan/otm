...
/**
 * <p>文件名称：OtmUpdateMessageAction.java</p>
 * <p>文件描述：更新消息</p>
 ...
 */
public class OtmUpdateMessageAction extends AbstractAction
{

    Logger log=Logger.getLogger(OtmUpdateMessageAction.class);
