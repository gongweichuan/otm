...
/**
 * <p>文件名称：OtmListVisitsAction.java</p>
 * <p>文件描述：</p>
 ...
 */
public class OtmListVisitsAction extends AbstractAction
{

Logger log=Logger.getLogger(OtmListVisitsAction.class);
    ...
    public Map perform(BaseDTO request)
    {
      ...
      // String visitId=null;
        ...
        if(service!=null)
        {
            list=service.selectVisits(inDTO);
        }
        else
        {
